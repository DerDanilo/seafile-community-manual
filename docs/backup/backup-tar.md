...
Download the script [BackupSeafileInstall](https://raw.githubusercontent.com/DerDanilo/scriptcollection/master/seafilebackup.sh "BackupSeafileInstall") and save it in `/usr/local/sbin/`.
